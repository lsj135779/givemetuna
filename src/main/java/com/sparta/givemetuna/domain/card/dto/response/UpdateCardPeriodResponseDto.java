...
public class UpdateCardPeriodResponseDto {
	...
	@Builder
	private UpdateCardPeriodResponseDto(Long boardId, Long stageId, String title,
	...
	public static UpdateCardPeriodResponseDto of(Card card) {

		return UpdateCardPeriodResponseDto.builder()

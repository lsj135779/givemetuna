...
public class SelectCardResponseDto {
    ...
    @Builder
    private SelectCardResponseDto(Long boardId, Long stageId, String title,
    ...
    public static SelectCardResponseDto of(Card card) {

        return SelectCardResponseDto.builder()

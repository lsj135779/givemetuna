...
public class UserController {
	...
	public ResponseEntity<UserInfoResponseDTO> updateUserProfile(@PathVariable(name = "account") String account,
	...
	public ResponseEntity<CommonResponseDTO> deleteUser(@PathVariable(name = "account") String account,
		@AuthenticationPrincipal UserDetailsImpl userDetails) {
